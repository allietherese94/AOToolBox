...
* To change the default scene background on the app interface, save the image you wish to use with the name "scene.png" and add it to iTunes. The scene background is a 2-D representation of the area where animals are observed. The default image is a set of concentric circles labeled with distances (in meters) on which individual animals can be placed. The width of this default background is 60m. 
